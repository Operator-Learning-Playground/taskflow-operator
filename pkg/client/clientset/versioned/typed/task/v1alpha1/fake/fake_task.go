...
var tasksResource = schema.GroupVersionResource{Group: "api.practice.com", Version: "v1alpha1", Resource: "tasks"}

var tasksKind = schema.GroupVersionKind{Group: "api.practice.com", Version: "v1alpha1", Kind: "Task"}
